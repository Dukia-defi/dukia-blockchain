...
contract AddLiquidityScript is Script {
    address constant ROUTER_ADDRESS = 0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008;  
...
function run() external {
        ...
        address myOwn = 0x245C6D6cd75753A4003946897E9B0f046186e797;
        uint256 myOwnAmount = 100 * 10**18; 

        dai.transfer(myOwn, myOwnAmount);
         console.log("My Own DAI balance:", dai.balanceOf(myOwn));
